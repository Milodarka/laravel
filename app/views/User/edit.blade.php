...
.wrapper 
{
    ...
    <form action="{{URL::to('update')}}" method="post">
        ...
        <?php 
            ...
            $userId=User::where('id',$ses_id->id)->get();
                    ?>
                    
                <input type="hidden" name="user_id" value={{$ses_id->id}}>
                    <br> <br>
        ...
        <tr>
           ...
           <td>
                <input type="text" name="name" id="name" placeholder="{{$info->name}}" required>
        ...
        <tr>
           ...
           <td>
                <input type="email" name="email" id="email" placeholder="{{$info->email}}" required>
        ...
        <tr>
           ...
           <td>
                <input type="text" name="password" id="password" placeholder="{{$info->password}}" required >
